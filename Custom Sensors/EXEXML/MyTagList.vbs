...
For x=1 To 30
    restReq.open "POST", "https://my.wirelesstag.net/ethAccount.asmx/SignIn", false
...
restReq.open "POST", "https://my.wirelesstag.net/ethAccount.asmx/IsSignedInEx", false
restReq.setRequestHeader "Content-Type", "application/json; charset=utf-8"
restReq.send "{}"
...
'restReq.open "POST", "https://my.wirelesstag.net/ethClient.asmx/GetServerTime2", false
'restReq.setRequestHeader "Content-Type", "application/json; charset=utf-8"
'restReq.send "{tzo: " & tzo & "}"

'restReq.open "POST", "https://my.wirelesstag.net/ethAccount.asmx/GetTagManagers", false
'restReq.setRequestHeader "Content-Type", "application/json; charset=utf-8"
'restReq.send "{}"

restReq.open "POST", "https://my.wirelesstag.net/ethClient.asmx/GetTagList", false
restReq.setRequestHeader "Content-Type", "application/json; charset=utf-8"
restReq.send "{}"
